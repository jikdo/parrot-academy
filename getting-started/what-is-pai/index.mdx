...
PAI is overcollateralized and it uses a dynamic interest rate to protect underlying assets.  Interest rate fees is paid to PAI [Stability pool](#) providers so it incentivize users to balance PAI-USDC liqudity pools to maintain peg. [ You can read more about how PAI's dynamic interest rate works here](https://gopartyparrot.medium.com/introducing-leverage-interest-rate-to-incentivize-parrot-stability-pool-3179c7c192ce)
